...
// Tulis sebuah character/teks ke output
typedef void (*chi_write_fn)(void *ctx, const char *s, int len);

// Abstraksi writer - menggunakan MemStream dari kernel
typedef MemStream ChiWriter;
